        ...
        <View style={styles.header}>
          ...
          >
            <Text style={[styles.title, props.titleStyle]}>
              {isCalendarReady &&
                displayTitleByLocale(props.locale, currDate, props.titleFormat)}
            </Text>
            <Entypo
          ...
          <TouchableOpacity
            style={{ ...styles.arrowButton, position: "absolute", right: 0 }}
            ...
            <View style={s.center}>
              ...
              >
                <TouchableOpacity onPress={toggleModal}>
                  <Text
                    style={{ color: "grey", fontSize: 16, marginLeft: "3%" }}
                  >
                    취소
                  </Text>
                </TouchableOpacity>
